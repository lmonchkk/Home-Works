...
let nmber2 = 34.567; // число с плавающей точкой
...
// Специальное хначени underfined
...
/*
    Оператор typeof - Нужен для определения типпа данных аргумента, либо данных, хранящихся в перемных
*/
